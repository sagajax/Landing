  ...
  return (
    <div className="w-full bg-black p-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        ...
        <div className="md:col-span-2 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 rounded-3xl p-8 relative overflow-hidden group hover:shadow-xl transition-all">
        ...
        <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 rounded-3xl p-8 relative overflow-hidden group hover:shadow-xl transition-all">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
